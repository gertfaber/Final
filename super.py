...
buy_parser.add_argument('--name', '-n'      , help='name off the product', required=True)
buy_parser.add_argument('--price', '-p'     , help='price off the product', required=True)
buy_parser.add_argument('--exp', '-x'       , help='epitation date off the product', required=True)
buy_parser.add_argument('--buy-date', '-bd' , help='date when you bought the product (if different from "today")')
